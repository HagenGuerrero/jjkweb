...
const characterData = {
  ...
  nanami: {
    ...
    description: 'Un hechicero de Grado 1 y mentor de Yuji Itadori. Nanami es un hombre pragmático y serio que una vez dejó el mundo del jujutsu para convertirse en un oficinista, solo para regresar después de darse cuenta de que su verdadera vocación era salvar a la gente. Valora las reglas y la eficiencia por encima de todo. ',
    abilities: [
      '<strong>Técnica de Proporción (十劃呪法, Tōkaku Juhō):</strong> Su técnica innata le permite crear puntos débiles en cualquier objetivo al dividirlo forzadamente en una proporción de 7:3. Golpear este punto garantiza un golpe crítico. ',
      '<strong>Voto Vinculante: Tiempo Extra (時間外労働, Jikangairōdō):</strong> Un voto que restringe su energía maldita durante sus "horas de trabajo". Una vez que entra en "tiempo extra", su poder aumenta considerablemente. ',
      '<strong>Colapso:</strong> Una técnica de extensión que le permite crear un gran punto débil en el entorno y destruirlo.',
    ],
    domainExpansion: null,
    curiosities: 'A pesar de su exterior estoico, se preocupa profundamente por sus aliados, especialmente por Yuji. Su muerte a manos de Mahito durante el Incidente de Shibuya es uno de los momentos más impactantes de la serie. ',
    gallery: [
      './img/nanami_2.webp',
      './img/nanami_3.webp',
    ],
  ...
  mahito: {
    ...
    description: 'Un espíritu maldito de grado especial nacido del odio y el miedo de los humanos hacia otros humanos. Mahito es sádico, inmaduro y disfruta jugando con las vidas humanas. Su filosofía se centra en que el alma precede al cuerpo, lo que le da una perspectiva aterradora sobre la vida y la muerte.',
    abilities: [
      '<strong>Transfiguración Ociosa (無為転変, Mui Tenpen):</strong> Su técnica le permite tocar el alma de una persona y remodelarla, alterando su cuerpo de formas grotescas o matándola instantáneamente. También puede curarse a sí mismo y cambiar su propia forma.',
    ...
    domainExpansion: '<strong>Encarnación Propia de la Perfección (自閉円頓裹, Jihei Endonka):</strong> Dentro de su dominio, su técnica de Transfiguración Ociosa se aplica a cualquiera atrapado, garantizando un golpe mortal. ',
    curiosities: 'Es el archienemigo de Yuji Itadori, ya que Yuji es una de las pocas personas que puede dañar directamente su alma. Mahito es responsable de la muerte de Kento Nanami y Junpei Yoshino, y de dejar a Nobara Kugisaki en coma. ',
    gallery: [
      './img/mahito_2.webp',
      './img/mahito_3.webp',
    ],
  ...
  hakari: {
    ...
    description: 'Un estudiante de tercer año de la Preparatoria de Jujutsu de Tokio, actualmente suspendido. Hakari dirige un club de lucha clandestino. Es considerado por Satoru Gojo como uno de los estudiantes con el potencial de superarlo. Es un individuo seguro de sí mismo y amante del riesgo, cuya técnica se basa en la suerte.',
    abilities: [
  ...
  kenjaku: {
    ...
    description: 'Un antiguo y malvado hechicero que ha vivido durante más de mil años utilizando su técnica innata para trasplantar su cerebro a diferentes cuerpos y apoderarse de ellos. Actualmente ocupa el cuerpo de Suguru Geto. Es el cerebro detrás de la mayoría de los eventos catastróficos de la serie.',
    abilities: [
      '<strong>Trasplante Cerebral:</strong> Su técnica innata le permite sobrevivir a la muerte y tomar el control de otros cuerpos, obteniendo acceso a sus recuerdos y técnicas malditas. ',
      '<strong>Manipulación de Espíritus Malditos:</strong> Al estar en el cuerpo de Geto, puede usar su técnica para controlar maldiciones que ha absorbido. ',
      '<strong>Técnicas Múltiples:</strong> Ha acumulado varias técnicas a lo largo de los siglos, incluyendo la antigravedad de la madre de Yuji, Kaori Itadori. ',
    ...
    curiosities: 'Kenjaku es técnicamente la "madre" de Yuji Itadori, ya que dio a luz a Yuji mientras poseía el cuerpo de Kaori Itadori. Su objetivo final es "optimizar" la energía maldita en todo Japón, forzando la evolución de la humanidad al fusionar a todos los no hechiceros con Tengen. ',
    gallery: [
      './img/kenjaku_2.webp',
      './img/kenjaku_3.webp',
    ],
  ...
  uraume: {
    ...
    description: 'Un usuario de maldiciones que ha vivido durante más de mil años y es un subordinado directo y leal de Ryomen Sukuna. Uraume es una figura misteriosa y poderosa, a menudo vista al lado de Sukuna. También es un excelente cocinero, una de las razones por las que Sukuna le mantiene cerca. ',
    abilities: [
      '<strong>Formación de Hielo (氷凝呪法, Hikori Juhō):</strong> La técnica maldita de Uraume le permite crear y manipular enormes cantidades de hielo.  Este poder es lo suficientemente fuerte como para congelar a grandes grupos de personas al instante. ',
      '<strong>Técnica de Maldición Inversa:</strong> Es capaz de utilizar la Técnica de Maldición Inversa para curarse a sí mismo. ',
      '<strong>Calma Muerta:</strong> Considerada la cima del Jujutsu de Hielo, utiliza energía maldita helada en lugar de hielo real para congelar a sus objetivos. ',
    ],
    domainExpansion: null,
    curiosities: 'Uraume ha servido a Sukuna desde la era Heian, hace más de 1,000 años, y su lealtad es absoluta. Sukuna le considera un aliado.  Tras la muerte de Sukuna, Uraume se quita la vida. ',
    gallery: [
      './img/uraume_2.webp',
      './img/uraume_3.webp',
    ],
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  async function populateAndShowView(charKey) {
    ...
    // Se ha eliminado la galería de la vista de detalles. Si por seguridad existe,
    // aseguramos que permanezca oculta.
    const secondaryGallery = characterView.querySelector('.secondary-gallery');
    if (secondaryGallery) secondaryGallery.style.display = 'none';
